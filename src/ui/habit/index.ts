/** Habit-specific components barrel — docs/ui-registry.md (`src/ui/habit/`). */
export {
  HabitForm,
  NEW_HABIT_DEFAULTS,
  type HabitFormProps,
...
export { HabitListRow, type HabitListRowProps } from "./HabitListRow";
export { HabitCard, type HabitCardProps } from "./HabitCard";
export { CheckControl, type CheckControlProps } from "./CheckControl";
export {
  CompletionSummary,
